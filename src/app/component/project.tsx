    ...
    <div className="flex flex-wrap -m-8">
      ...
      <div className="lg:w-1/3 sm:w-1/2 p-4 cursor-pointer">
        <div className="flex relative">
          <div
            className="absolute inset-0 w-full h-full object-cover object-center bg-black text-yellow-400
            font-medium title-font text-3xl text-center justify-center">
              Calculator
              </div>
